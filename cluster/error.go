...
var clusterError = map[string]string{
	...
	"ERR00033":  "Skip slave in election %s have no master log file, may be failed slave",
	"ERR00034":  "Skip slave in election %s repl not electectable for switchover",
	"ERR00035":  "Skip slave in election %s multi-master and is already the master",
	"ERR00036":  "Skip slave in election %s is relay",
	"ERR00037":  "Skip slave in election %s in ingore list ",
	"ERR00038":  "Skip slave in election %s repl not electectable for failover",
	...
	"ERR00043":  "Skip slave in election %s Semisync repport unsync",
