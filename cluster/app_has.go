...
func (app *App) HasConfigRefreshCookie() bool {
	return app.hasCookie("cookie_configrefresh")
}

func (app *App) HasNoConfigFetchCookie() bool {
	return app.hasCookie("cookie_noconfigfetch")
}
