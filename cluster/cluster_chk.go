		...
		for i, line := range lines {
			if i == 1 {
				...
				if line != "" {
					...
					//cluster.LogPrintf(LvlWarn, "An immutable parameter has been changed in cluster %s and is tracked in overwrite.toml. Use the config-merge command to save your changes.\n", cluster.Name)
