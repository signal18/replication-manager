                ...
                onSwitchChange={() =>
                  dispatch(
                    switchSetting({
                      ...
                      setting: 'scheduler-db-servers-logical-backup'
                    })
                  )
                }
                onSave={(value) =>
              ...
              <Scheduler
                ...
                onSwitchChange={() =>
                  dispatch(
                    switchSetting({
                      clusterName: selectedCluster?.name,
                      setting: 'scheduler-db-servers-physical-backup'
                    })
                  )
                }
                onSave={(value) =>
          ...
          },
          {
            ...
            value: (
              <Scheduler
                ...
                onSwitchChange={() =>
                  dispatch(
                    switchSetting({ clusterName: selectedCluster?.name, setting: 'scheduler-db-servers-optimize' })
                  )
                }
                onSave={(value) =>
                  dispatch(
          ...
          },
          {
            ...
            value: (
              <Scheduler
                ...
                onSwitchChange={() =>
                  dispatch(
                    switchSetting({ clusterName: selectedCluster?.name, setting: 'scheduler-db-servers-analyze' })
                  )
                }
                onSave={(value) =>
                  dispatch(
              ...
              <Scheduler
                ...
                onSwitchChange={() =>
                  dispatch(
                    switchSetting({
                      clusterName: selectedCluster?.name,
                      setting: 'scheduler-db-servers-logs-table-rotate'
                    })
                  )
                }
                onSave={(value) =>
