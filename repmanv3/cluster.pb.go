...
var file_cluster_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x2d, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x32, 0xf7, 0x0b, 0x0a, 0x0e, 0x43, 0x6c,
	...
	0x74, 0x65, 0x73, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_cluster_proto_depIdxs = []int32{
	...
	4, // 8: signal18.replication_manager.v3.ClusterPublicService.ClusterStatus:output_type -> signal18.replication_manager.v3.StatusMessage
	5, // 9: signal18.replication_manager.v3.ClusterPublicService.MasterPhysicalBackup:output_type -> google.protobuf.Empty
	6, // 10: signal18.replication_manager.v3.ClusterService.GetCluster:output_type -> google.protobuf.Struct
	6, // 11: signal18.replication_manager.v3.ClusterService.GetSettingsForCluster:output_type -> google.protobuf.Struct
	5, // 12: signal18.replication_manager.v3.ClusterService.SetActionForClusterSettings:output_type -> google.protobuf.Empty
	5, // 13: signal18.replication_manager.v3.ClusterService.PerformClusterAction:output_type -> google.protobuf.Empty
	6, // 14: signal18.replication_manager.v3.ClusterService.RetrieveFromTopology:output_type -> google.protobuf.Struct
	7, // 15: signal18.replication_manager.v3.ClusterService.GetClientCertificates:output_type -> signal18.replication_manager.v3.Certificate
