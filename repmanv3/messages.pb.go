...
var file_messages_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x2a, 0x55, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1d, 0x0a, 0x19, 0x53, 0x45, 0x52, 0x56, 0x49,
	...
	0x02, 0x12, 0x0a, 0x0a, 0x06, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x53, 0x10, 0x03, 0x42, 0x32, 0x5a,
	0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x69, 0x67, 0x6e,
	0x61, 0x6c, 0x31, 0x38, 0x2f, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x2d, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x3b, 0x72, 0x65, 0x70, 0x6d, 0x61, 0x6e, 0x76,
...
var file_messages_proto_goTypes = []interface{}{
	...
	nil,                                     // 24: signal18.replication_manager.v3.Cluster.MonitorTypeEntry
	nil,                                     // 25: signal18.replication_manager.v3.Cluster.TopologyTypeEntry
	nil,                                     // 26: signal18.replication_manager.v3.Cluster.FsTypeEntry
	nil,                                     // 27: signal18.replication_manager.v3.Cluster.DiskTypeEntry
	nil,                                     // 28: signal18.replication_manager.v3.Cluster.VmTypeEntry
	(*ClusterSetting_Setting)(nil),          // 29: signal18.replication_manager.v3.ClusterSetting.Setting
	(*ClusterSetting_Switch)(nil),           // 30: signal18.replication_manager.v3.ClusterSetting.Switch
	(*ClusterAction_Server)(nil),            // 31: signal18.replication_manager.v3.ClusterAction.Server
	(*gtid.Gtid)(nil),                       // 32: signal18.replication_manager.v3.Gtid
}
var file_messages_proto_depIdxs = []int32{
	...
	24, // 2: signal18.replication_manager.v3.Cluster.monitor_type:type_name -> signal18.replication_manager.v3.Cluster.MonitorTypeEntry
	25, // 3: signal18.replication_manager.v3.Cluster.topology_type:type_name -> signal18.replication_manager.v3.Cluster.TopologyTypeEntry
	26, // 4: signal18.replication_manager.v3.Cluster.fs_type:type_name -> signal18.replication_manager.v3.Cluster.FsTypeEntry
	27, // 5: signal18.replication_manager.v3.Cluster.disk_type:type_name -> signal18.replication_manager.v3.Cluster.DiskTypeEntry
	28, // 6: signal18.replication_manager.v3.Cluster.vm_type:type_name -> signal18.replication_manager.v3.Cluster.VmTypeEntry
	13, // 7: signal18.replication_manager.v3.ClusterSetting.cluster:type_name -> signal18.replication_manager.v3.Cluster
	...
	29, // 9: signal18.replication_manager.v3.ClusterSetting.setting:type_name -> signal18.replication_manager.v3.ClusterSetting.Setting
	30, // 10: signal18.replication_manager.v3.ClusterSetting.switch:type_name -> signal18.replication_manager.v3.ClusterSetting.Switch
	13, // 11: signal18.replication_manager.v3.ClusterAction.cluster:type_name -> signal18.replication_manager.v3.Cluster
	4,  // 12: signal18.replication_manager.v3.ClusterAction.action:type_name -> signal18.replication_manager.v3.ClusterAction.Action
	31, // 13: signal18.replication_manager.v3.ClusterAction.server:type_name -> signal18.replication_manager.v3.ClusterAction.Server
	...
	13, // 16: signal18.replication_manager.v3.TopologyRetrieval.cluster:type_name -> signal18.replication_manager.v3.Cluster
	...
	13, // 18: signal18.replication_manager.v3.TableAction.cluster:type_name -> signal18.replication_manager.v3.Cluster
	22, // 19: signal18.replication_manager.v3.TableAction.table:type_name -> signal18.replication_manager.v3.Table
	10, // 20: signal18.replication_manager.v3.TableAction.action:type_name -> signal18.replication_manager.v3.TableAction.Action
	32, // 21: signal18.replication_manager.v3.Cluster.Crash.failover_io_gtids:type_name -> signal18.replication_manager.v3.Gtid
	2,  // 22: signal18.replication_manager.v3.ClusterSetting.Setting.name:type_name -> signal18.replication_manager.v3.ClusterSetting.Setting.SettingName
	3,  // 23: signal18.replication_manager.v3.ClusterSetting.Switch.name:type_name -> signal18.replication_manager.v3.ClusterSetting.Switch.SwitchName
	6,  // 24: signal18.replication_manager.v3.ClusterAction.Server.type:type_name -> signal18.replication_manager.v3.ClusterAction.Server.Type
	7,  // 25: signal18.replication_manager.v3.ClusterAction.Server.database:type_name -> signal18.replication_manager.v3.ClusterAction.Server.Database
	8,  // 26: signal18.replication_manager.v3.ClusterAction.Server.proxy:type_name -> signal18.replication_manager.v3.ClusterAction.Server.Proxy
