...
// Deprecated: Use google.protobuf.Struct instead.
// See ClusterStatus gRPC method which now returns google.protobuf.Struct.
...
// Deprecated: Use google.protobuf.Struct instead.
// See GetClientCertificates gRPC method which now returns google.protobuf.Struct.
...
// Deprecated: Use google.protobuf.Struct instead.
// See GetBackups gRPC method which now returns stream google.protobuf.Struct.
type Backup struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
// Deprecated: Use google.protobuf.Struct instead.
// See GetTags gRPC method which now returns stream google.protobuf.Struct.
type Tag struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
// Deprecated: Use google.protobuf.Struct instead.
// See GetSchema gRPC method which now returns stream google.protobuf.Struct.
type Table struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
const file_messages_proto_rawDesc = "" +
	"\n" +
	"\x0emessages.proto\x12\x1fsignal18.replication_manager.v3\"o\n" +
	"\tErrorInfo\x12\x16\n" +
	"\x06reason\x18\x01 \x01(\tR\x06reason\x12J\n" +
	"\bresource\x18\x02 \x01(\v2..signal18.replication_manager.v3.ErrorResourceR\bresource\"A\n" +
	"\rErrorResource\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12\x1a\n" +
	"\bcontents\x18\x02 \x01(\tR\bcontents\"O\n" +
	"\aCluster\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x120\n" +
	"\x13clusterShardingName\x18\x02 \x01(\tR\x13clusterShardingName\"\xe3 \n" +
	"\x0eClusterSetting\x12B\n" +
	"\acluster\x18\x01 \x01(\v2(.signal18.replication_manager.v3.ClusterR\acluster\x12N\n" +
	"\x06action\x18\x03 \x01(\x0e26.signal18.replication_manager.v3.ClusterSetting.ActionR\x06action\x12\x1b\n" +
	"\ttag_value\x18\x04 \x01(\tR\btagValue\x12Q\n" +
	"\asetting\x18\x05 \x01(\v27.signal18.replication_manager.v3.ClusterSetting.SettingR\asetting\x12N\n" +
	"\x06switch\x18\x06 \x01(\v26.signal18.replication_manager.v3.ClusterSetting.SwitchR\x06switch\x1a\xd6\x0e\n" +
	"\aSetting\x12W\n" +
	"\x04name\x18\x01 \x01(\x0e2C.signal18.replication_manager.v3.ClusterSetting.Setting.SettingNameR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\xdb\r\n" +
	"\vSettingName\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13BACKUP_BINLOGS_KEEP\x10\x01\x12\x15\n" +
	"\x11BACKUP_KEEP_DAILY\x10\x02\x12\x16\n" +
	"\x12BACKUP_KEEP_HOURLY\x10\x03\x12\x17\n" +
	"\x13BACKUP_KEEP_MONTHLY\x10\x04\x12\x16\n" +
	"\x12BACKUP_KEEP_WEEKLY\x10\x05\x12\x16\n" +
	"\x12BACKUP_KEEP_YEARLY\x10\x06\x12\x17\n" +
	"\x13BACKUP_LOGICAL_TYPE\x10\a\x12\x18\n" +
	"\x14BACKUP_PHYSICAL_TYPE\x10\b\x12\x19\n" +
	"\x15DB_SERVERS_CREDENTIAL\x10\t\x12\x14\n" +
	"\x10DB_SERVERS_HOSTS\x10\n" +
	"\x12\x12\n" +
	"\x0eFAILOVER_LIMIT\x10\v\x12\x1c\n" +
	"\x18FAILOVER_MAX_SLAVE_DELAY\x10\f\x12\x1f\n" +
	"\x1bMAXSCALE_SERVERS_CREDENTIAL\x10\r\x12\x16\n" +
	"\x12MONITORING_ADDRESS\x10\x0e\x12\x12\n" +
	"\x0ePROV_DB_AGENTS\x10\x0f\x12\x15\n" +
	"\x11PROV_DB_CPU_CORES\x10\x10\x12\x17\n" +
	"\x13PROV_DB_DISK_DEVICE\x10\x11\x12\x13\n" +
	"\x0fPROV_DB_DISK_FS\x10\x12\x12\x15\n" +
	"\x11PROV_DB_DISK_IOPS\x10\x13\x12\x15\n" +
	"\x11PROV_DB_DISK_POOL\x10\x14\x12\x15\n" +
	"\x11PROV_DB_DISK_SIZE\x10\x15\x12\x15\n" +
	"\x11PROV_DB_DISK_TYPE\x10\x16\x12\x1b\n" +
	"\x17PROV_DB_EXPIRE_LOG_DAYS\x10\x17\x12\x11\n" +
	"\rPROV_DB_IMAGE\x10\x18\x12\x1b\n" +
	"\x17PROV_DB_MAX_CONNECTIONS\x10\x19\x12\x12\n" +
	"\x0ePROV_DB_MEMORY\x10\x1a\x12\x18\n" +
	"\x14PROV_DB_SERVICE_TYPE\x10\x1b\x12\x18\n" +
	"\x14PROV_NET_CNI_CLUSTER\x10\x1c\x12\x1d\n" +
	"\x19PROV_ORCHESTRATOR_CLUSTER\x10\x1d\x12\x15\n" +
	"\x11PROV_ORCHESTRATOR\x10\x1e\x12\x15\n" +
	"\x11PROV_PROXY_AGENTS\x10\x1f\x12\x18\n" +
	"\x14PROV_PROXY_CPU_CORES\x10 \x12\x1a\n" +
	"\x16PROV_PROXY_DISK_DEVICE\x10!\x12\x16\n" +
	"\x12PROV_PROXY_DISK_FS\x10\"\x12\x18\n" +
	"\x14PROV_PROXY_DISK_POOL\x10#\x12\x18\n" +
	"\x14PROV_PROXY_DISK_SIZE\x10$\x12\x18\n" +
	"\x14PROV_PROXY_DISK_TYPE\x10%\x12!\n" +
	"\x1dPROV_PROXY_DOCKER_HAPROXY_IMG\x10&\x12\"\n" +
	"\x1ePROV_PROXY_DOCKER_MAXSCALE_IMG\x10'\x12\"\n" +
	"\x1ePROV_PROXY_DOCKER_PROXYSQL_IMG\x10/\x12$\n" +
	" PROV_PROXY_DOCKER_SHARDPROXY_IMG\x100\x12\x15\n" +
	"\x11PROV_PROXY_MEMORY\x101\x12\x1b\n" +
	"\x17PROV_PROXY_SERVICE_TYPE\x102\x12\x15\n" +
	"\x11PROV_SERVICE_PLAN\x103\x12\x13\n" +
	"\x0fPROV_SPHINX_IMG\x104\x12)\n" +
	"%PROXY_SERVERS_BACKEND_MAX_CONNECTIONS\x105\x12-\n" +
	")PROXY_SERVERS_BACKEND_MAX_REPLICATION_LAG\x106\x12\x1f\n" +
	"\x1bPROXYSQL_SERVERS_CREDENTIAL\x107\x12\x1a\n" +
	"\x16REPLICATION_CREDENTIAL\x108\x12,\n" +
	"(SCHEDULER_DB_SERVERS_LOGICAL_BACKUP_CRON\x109\x12\"\n" +
	"\x1eSCHEDULER_DB_SERVERS_LOGS_CRON\x10:\x12/\n" +
	"+SCHEDULER_DB_SERVERS_LOGS_TABLE_ROTATE_CRON\x10;\x12&\n" +
	"\"SCHEDULER_DB_SERVERS_OPTIMIZE_CRON\x10<\x12-\n" +
	")SCHEDULER_DB_SERVERS_PHYSICAL_BACKUP_CRON\x10=\x12\x1b\n" +
	"\x17SCHEDULER_JOBS_SSH_CRON\x10>\x12!\n" +
	"\x1dSCHEDULER_ROLLING_REPROV_CRON\x10?\x12\"\n" +
	"\x1eSCHEDULER_ROLLING_RESTART_CRON\x10@\x12\x1d\n" +
	"\x19SCHEDULER_SLA_ROTATE_CRON\x10A\x12!\n" +
	"\x1dSHARDPROXY_SERVERS_CREDENTIAL\x10B\x12 \n" +
	"\x1cSWITCHOVER_WAIT_ROUTE_CHANGE\x10C\x1a\xf6\r\n" +
	"\x06Switch\x12U\n" +
	"\x04name\x18\x01 \x01(\x0e2A.signal18.replication_manager.v3.ClusterSetting.Switch.SwitchNameR\x04name\"\x94\r\n" +
	"\n" +
	"SwitchName\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18AUTOREJOIN_BACKUP_BINLOG\x10\x01\x12 \n" +
	"\x1cAUTOREJOIN_FLASHBACK_ON_SYNC\x10\x02\x12\"\n" +
	"\x1eAUTOREJOIN_FLASHBACK_ON_UNSYNC\x10\x03\x12\x18\n" +
	"\x14AUTOREJOIN_FLASHBACK\x10\x04\x12\x1d\n" +
	"\x19AUTOREJOIN_LOGICAL_BACKUP\x10\x05\x12\x18\n" +
	"\x14AUTOREJOIN_MYSQLDUMP\x10\x06\x12\x1e\n" +
	"\x1aAUTOREJOIN_PHYSICAL_BACKUP\x10\a\x12)\n" +
	"%AUTOREJOIN_SLAVE_POSITIONAL_HEARTBEAT\x10\b\x12\x1c\n" +
	"\x18AUTOREJOIN_ZFS_FLASHBACK\x10\t\x12\x0e\n" +
	"\n" +
	"AUTOREJOIN\x10\n" +
	"\x12\f\n" +
	"\bAUTOSEED\x10\v\x12\x12\n" +
	"\x0eBACKUP_BINLOGS\x10\f\x12\x11\n" +
	"\rBACKUP_RESTIC\x10\r\x12\x1d\n" +
	"\x19CHECK_REPLICATION_FILTERS\x10\x0e\x12\x1b\n" +
	"\x17CHECK_REPLICATION_STATE\x10\x0f\x12\x16\n" +
	"\x12DATABASE_HEARTBEAT\x10\x10\x12\x14\n" +
	"\x10FAILOVER_AT_SYNC\x10\x11\x12\x1c\n" +
	"\x18FAILOVER_EVENT_SCHEDULER\x10\x12\x12\x19\n" +
	"\x15FAILOVER_EVENT_STATUS\x10\x13\x12\x11\n" +
	"\rFAILOVER_MODE\x10\x14\x12\x1b\n" +
	"\x17FAILOVER_READONLY_STATE\x10\x15\x12\x1b\n" +
	"\x17FAILOVER_RESTART_UNSAFE\x10\x16\x12\x1c\n" +
	"\x18FORCE_SLAVE_NO_GTID_MODE\x10\x17\x12\x15\n" +
	"\x11GRAPHITE_EMBEDDED\x10\x18\x12\x14\n" +
	"\x10GRAPHITE_METRICS\x10\x19\x12\x16\n" +
	"\x12MONITORING_CAPTURE\x10\x1a\x12\x1c\n" +
	"\x18MONITORING_INNODB_STATUS\x10\x1b\x12\x14\n" +
	"\x10MONITORING_PAUSE\x10\x1c\x12\x1a\n" +
	"\x16MONITORING_PROCESSLIST\x10\x1d\x12\x16\n" +
	"\x12MONITORING_QUERIES\x10\x1e\x12\x1a\n" +
	"\x16MONITORING_SAVE_CONFIG\x10\x1f\x12\x18\n" +
	"\x14MONITORING_SCHEDULER\x10 \x12\x1c\n" +
	"\x18MONITORING_SCHEMA_CHANGE\x10!\x12\x1c\n" +
	"\x18MONITORING_VARIABLE_DIFF\x10\"\x12 \n" +
	"\x1cPROV_DB_APPLY_DYNAMIC_CONFIG\x10#\x12\x1e\n" +
	"\x1aPROV_DOCKER_DAEMON_PRIVATE\x10$\x12\x10\n" +
	"\fPROV_NET_CNI\x10%\x12%\n" +
	"!PROXY_SERVERS_BACKEND_COMPRESSION\x10&\x12 \n" +
	"\x1cPROXY_SERVERS_READ_ON_MASTER\x10'\x12!\n" +
	"\x1dPROXYSQL_BOOTSTRAP_HOSTGROUPS\x10(\x12\"\n" +
	"\x1ePROXYSQL_BOOTSTRAP_QUERY_RULES\x10)\x12\x1e\n" +
	"\x1aPROXYSQL_BOOTSTRAP_SERVERS\x10*\x12\x1c\n" +
	"\x18PROXYSQL_BOOTSTRAP_USERS\x10+\x12 \n" +
	"\x1cPROXYSQL_BOOTSTRAP_VARIABLES\x10,\x12\x16\n" +
	"\x12PROXYSQL_BOOTSTRAP\x10-\x12\x18\n" +
	"\x14PROXYSQL_COPY_GRANTS\x10.\x12\f\n" +
	"\bPROXYSQL\x10/\x12'\n" +
	"#SCHEDULER_DB_SERVERS_LOGICAL_BACKUP\x100\x12*\n" +
	"&SCHEDULER_DB_SERVERS_LOGS_TABLE_ROTATE\x101\x12\x1d\n" +
	"\x19SCHEDULER_DB_SERVERS_LOGS\x102\x12!\n" +
	"\x1dSCHEDULER_DB_SERVERS_OPTIMIZE\x103\x12(\n" +
	"$SCHEDULER_DB_SERVERS_PHYSICAL_BACKUP\x104\x12\x16\n" +
	"\x12SCHEDULER_JOBS_SSH\x105\x12\x1c\n" +
	"\x18SCHEDULER_ROLLING_REPROV\x106\x12\x1d\n" +
	"\x19SCHEDULER_ROLLING_RESTART\x107\x12\x1a\n" +
	"\x16SHARDPROXY_COPY_GRANTS\x108\x12\x16\n" +
	"\x12SWITCHOVER_AT_SYNC\x109\x12\b\n" +
	"\x04TEST\x10:\x12\v\n" +
	"\aVERBOSE\x10;\"\xaa\x01\n" +
	"\x06Action\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\f\n" +
	"\bDISCOVER\x10\x01\x12\x18\n" +
	"\x14APPLY_DYNAMIC_CONFIG\x10\x02\x12\n" +
	"\n" +
	"\x06RELOAD\x10\x03\x12\a\n" +
	"\x03SET\x10\x04\x12\n" +
	"\n" +
	"\x06SWITCH\x10\x05\x12\x0e\n" +
	"\n" +
	"ADD_DB_TAG\x10\n" +
	"\x12\x0f\n" +
	...
	"\x06server\x18\x04 \x01(\v25.signal18.replication_manager.v3.ClusterAction.ServerR\x06server\x12^\n" +
	"\btopology\x18\x05 \x01(\x0e2B.signal18.replication_manager.v3.ClusterAction.ReplicationTopologyR\btopology\x1a\xc1\x04\n" +
	"\x06Server\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\x04R\x04port\x12N\n" +
	"\x04type\x18\x03 \x01(\x0e2:.signal18.replication_manager.v3.ClusterAction.Server.TypeR\x04type\x12Z\n" +
	"\bdatabase\x18\x04 \x01(\x0e2>.signal18.replication_manager.v3.ClusterAction.Server.DatabaseR\bdatabase\x12Q\n" +
	"\x05proxy\x18\x05 \x01(\x0e2;.signal18.replication_manager.v3.ClusterAction.Server.ProxyR\x05proxy\"5\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bDATABASE\x10\x01\x12\t\n" +
	"\x05PROXY\x10\x02\"Y\n" +
	"\bDatabase\x12\x18\n" +
	"\x14DATABASE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aMARIADB\x10\x01\x12\v\n" +
	"\aPERCONA\x10\x02\x12\t\n" +
	"\x05MYSQL\x10\x03\x12\x0e\n" +
	"\n" +
	"POSTGRESQL\x10\x04\"~\n" +
	"\x05Proxy\x12\x15\n" +
	"\x11PROXY_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bMAXSCALE\x10\x01\x12\f\n" +
	"\bPROXYSQL\x10\x02\x12\x0e\n" +
	"\n" +
	"SHARDPROXY\x10\x03\x12\v\n" +
	"\aHAPROXY\x10\x04\x12\v\n" +
	...
	"\x03ADD\x10\x01\x12\r\n" +
	"\tADDSERVER\x10\x02\x12\x19\n" +
	"\x15CANCEL_ROLLING_REPROV\x10\x03\x12\x1a\n" +
	"\x16CANCEL_ROLLING_RESTART\x10\x04\x12\x17\n" +
	"\x13CHECKSUM_ALL_TABLES\x10\x05\x12\f\n" +
	"\bFAILOVER\x10\x06\x12\x1a\n" +
	"\x16MASTER_PHYSICAL_BACKUP\x10\a\x12\f\n" +
	"\bOPTIMIZE\x10\b\x12\x1a\n" +
	"\x16RESET_FAILOVER_CONTROL\x10\n" +
	"\x12\r\n" +
	"\tRESET_SLA\x10\v\x12\v\n" +
	"\aROLLING\x10\f\x12\x0e\n" +
	"\n" +
	"ROTATEKEYS\x10\r\x12\x11\n" +
	"\rSTART_TRAFFIC\x10\x0e\x12\x10\n" +
	"\fSTOP_TRAFFIC\x10\x0f\x12\x0e\n" +
	"\n" +
	"SWITCHOVER\x10\x10\x12\f\n" +
	...
	"\x14MASTER_SLAVE_NO_GTID\x10\x02\x12\x10\n" +
	"\fMULTI_MASTER\x10\x03\x12\x14\n" +
	"\x10MULTI_TIER_SLAVE\x10\x04\x12\x13\n" +
	"\x0fMAXSCALE_BINLOG\x10\x05\x12\x15\n" +
	"\x11MULTI_MASTER_RING\x10\x06\x12\x16\n" +
	"\x12MULTI_MASTER_WSREP\x10\a\"U\n" +
	"\rStatusMessage\x12D\n" +
	"\x05alive\x18\x01 \x01(\x0e2..signal18.replication_manager.v3.ServiceStatusR\x05alive\"\xae\x02\n" +
	"\x11TopologyRetrieval\x12B\n" +
	"\acluster\x18\x01 \x01(\v2(.signal18.replication_manager.v3.ClusterR\acluster\x12X\n" +
	"\bretrieve\x18\x02 \x01(\x0e2<.signal18.replication_manager.v3.TopologyRetrieval.RetrievalR\bretrieve\"{\n" +
	"\tRetrieval\x12\x19\n" +
	"\x15RETRIEVAL_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06ALERTS\x10\x01\x12\v\n" +
	"\aCRASHES\x10\x02\x12\b\n" +
	"\x04LOGS\x10\x03\x12\n" +
	"\n" +
	"\x06MASTER\x10\x04\x12\v\n" +
	"\aPROXIES\x10\x05\x12\v\n" +
	"\aSERVERS\x10\x06\x12\n" +
	"\n" +
	"\x06SLAVES\x10\a\"y\n" +
	"\vCertificate\x12-\n" +
	"\x12client_certificate\x18\x01 \x01(\tR\x11clientCertificate\x12\x1d\n" +
	"\n" +
	"client_key\x18\x02 \x01(\tR\tclientKey\x12\x1c\n" +
	"\tauthority\x18\x03 \x01(\tR\tauthority\"\xce\x01\n" +
	"\x06Backup\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\bshort_id\x18\x02 \x01(\tR\bshort_id\x12\x12\n" +
	...
	"\x03uid\x18\b \x01(\x03R\x03uid\x12\x10\n" +
	"\x03gid\x18\t \x01(\x03R\x03gid\"E\n" +
	"\x03Tag\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1a\n" +
	"\bcategory\x18\x03 \x01(\tR\bcategory\"\xa7\x02\n" +
	"\x05Table\x12!\n" +
	...
	"\n" +
	"table_rows\x18\x04 \x01(\x03R\ttableRows\x12\x1f\n" +
	"\vdata_length\x18\x05 \x01(\x03R\n" +
	"dataLength\x12!\n" +
	"\findex_length\x18\x06 \x01(\x03R\vindexLength\x12\x1b\n" +
	"\ttable_crc\x18\a \x01(\x04R\btableCrc\x12%\n" +
	"\x0etable_clusters\x18\b \x01(\tR\rtableClusters\x12\x1d\n" +
	"\n" +
	"table_sync\x18\t \x01(\tR\ttableSync*U\n" +
	"\rServiceStatus\x12\x1d\n" +
	"\x19SERVICESTATUS_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aRUNNING\x10\x01\x12\f\n" +
	"\bSTARTING\x10\x02\x12\n" +
	"\n" +
	"\x06ERRORS\x10\x03B2Z0github.com/signal18/replication-manager;repmanv3b\x06proto3"
