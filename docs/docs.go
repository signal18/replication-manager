...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/clusters/{clusterName}/actions/analyze-all-tables/{persistent}": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully triggered analyze calculation for all tables",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/clusters/{clusterName}/actions/restic-mount-toggle": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Mount toggle request with optional mount options",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.ResticMountToggleRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Mount status after operation",
                        "schema": {
                            "$ref": "#/definitions/server.ResticMountStatusResponse"
                        }
                    },
                    "400": {
                    ...
                    "409": {
                        "description": "Mount already active at different path",
                        "schema": {
                            "type": "string"
                        }
                    },
                        ...
                        "schema": {
                            ...
                            "items": {
                                ...
                                "additionalProperties": {
                                    "$ref": "#/definitions/backupmgr.BackupMetadata"
                                }
                            }
                        }
                    },
        ...
        "/api/clusters/{clusterName}/backups/reconcile": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Reconciliation report with orphaned and missing metadata",
                        "schema": {
                            "$ref": "#/definitions/cluster.ReconciliationReport"
                        }
                    },
                    "403": {
                        "description": "No valid ACL",
        ...
        "/api/clusters/{clusterName}/restic/fetch": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Restic snapshots fetch queued",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/clusters/{clusterName}/restic/init": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Restic repository initialized",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/clusters/{clusterName}/restic/init/{force}": {
            "post": {
                "description": "Inits the restic repository for the specified cluster.",
                "produces": [
                    "application/json"
        ...
        "/api/clusters/{clusterName}/restic/mount-status": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Restic manager not available",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/api/clusters/{clusterName}/restic/purge/{snapshotID}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Dry run restic purge",
                        "name": "dry_run",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Restic repository purged",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/clusters/{clusterName}/restic/restore-config/{force}": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Restic config restore done",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/clusters/{clusterName}/restic/snapshots": {
            "get": {
                "description": "This endpoint retrieves the backups for the specified cluster.",
                "produces": [
                    "application/json"
        ...
        "/api/clusters/{clusterName}/restic/stats": {
            "get": {
                "description": "This endpoint retrieves the backup stats for the specified cluster.",
                "produces": [
                    "application/json"
        ...
        "/api/clusters/{clusterName}/restic/task-queue": {
            "get": {
        ...
        "/api/clusters/{clusterName}/restic/task-queue/move/{moveType}/{taskID}": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Task queue modified",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/clusters/{clusterName}/restic/unlock": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Restic repository unlocked",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/clusters/{clusterName}/schema/{schemaName}/all/actions/analyze-schema/{persistent}": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully triggered analyze calculation for the schema",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/clusters/{clusterName}/schema/{schemaName}/all/actions/checksum-schema": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully triggered checksum calculation for the schema",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/clusters/{clusterName}/servers/{serverName}/actions/reseed-restic": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.ResticReseedRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Reseed queued successfully",
                        "schema": {
                            "type": "string"
                        }
                    },
                    ...
                    "409": {
                        "description": "Metadata not ready or reseed already queued",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "500": {
                        "description": "Reseed failed",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/meet/add/{channelId}/{userId}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "User added to the channel successfully",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "object",
        ...
        "/meet/create/private/{channelName}": {
            "get": {
        ...
        "/meet/create/public/{channelName}": {
            "get": {
        ...
        "/meet/post/jitsi/{channelId}/{meetingId}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "ID of the Jitsi meeting",
                        "name": "meetingId",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Jitsi meeting link posted successfully",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "object",
        ...
        "/meet/read/{channelId}/{page}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "page number fetch messages from",
                        "name": "page",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/meethelper.MeetChannelMessages"
                        }
                    },
                    "401": {
                        "description": "Unauthorized user",
        ...
        "/meet/upload/{channelId}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Message to accompany the file",
                        "name": "message",
                        "in": "formData"
                    }
                ],
        ...
        "/meet/view/{channelId}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Messages viewed successfully",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "object",
    ...
    "definitions": {
        "backupmgr.BackupMetaMap": {
            "type": "object"
        },
        "backupmgr.BackupMetadata": {
            "type": "object",
            "properties": {
                "backupLine": {
                    "type": "string"
        ...
        "backupmgr.ResticBackupOption": {
            ...
            "properties": {
                ...
                "dry_run": {
                    "description": "Don't upload, just show what would be done",
                    "type": "boolean"
                },
                "exclude": {
                ...
                "exclude_caches": {
                    "description": "Exclude cache directories",
                    "type": "boolean"
                },
                "exclude_file": {
                    "description": "Files containing exclude patterns",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "exclude_if_present": {
                    "description": "Exclude dirs containing these files",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "exclude_larger_than": {
                    "description": "Max file size (e.g., \"100M\")",
                    "type": "string"
                },
                "files_from": {
                    "description": "Read files to backup from file",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "parent": {
                    "description": "Parent snapshot for incremental",
                    "type": "string"
                },
                "tags": {
                    "type": "array",
                ...
                "time": {
                    "description": "Backup timestamp (e.g., '2012-11-01 22:08:41')",
                    "type": "string"
                }
            }
        },
        "backupmgr.ResticChangePassOption": {
            "type": "object"
        },
        "backupmgr.ResticCheckOption": {
            "type": "object",
            "properties": {
                "check_unused": {
                    "description": "Check for unused blobs (removed in newer versions)",
                    "type": "boolean"
                },
                "read_data": {
                    "description": "Read all data blobs (slow, comprehensive)",
                    "type": "boolean"
                },
                "read_data_subset": {
                    "description": "Read subset of data (e.g., \"10%\", \"5G\", \"1/5\")",
                    "type": "string"
                },
                "with_cache": {
                    "description": "Use cache (default: false for check)",
                    "type": "boolean"
                }
            }
        },
        "backupmgr.ResticFetchOption": {
            "type": "object",
            "properties": {
                "skip_stats": {
                    "type": "boolean"
        ...
        "backupmgr.ResticInitOption": {
            ...
            "properties": {
                ...
                "repository_version": {
                    "description": "e.g., \"stable\", \"latest\", \"1\", \"2\"",
                    "type": "string"
                }
            }
        },
        "backupmgr.ResticMountOption": {
            "type": "object",
            "properties": {
                "allow_other": {
                ...
                "no_default_permissions": {
                    "description": "Ignore Unix permissions (--no-default-permissions)",
                    "type": "boolean"
                },
                "no_lock": {
                ...
                "owner_root": {
                    "description": "Use root as owner (--owner-root)",
                    "type": "boolean"
                },
                "path": {
                    "description": "Filter by path(s) (--path)",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "path_template": {
                    "description": "Path/Time Templates",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "quiet": {
                    "description": "Quiet mode (-q, --quiet)",
                    "type": "boolean"
                },
                "tag": {
                    "description": "Filter by tag(s) (--tag)",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "time_template": {
                    "description": "Template for times (--time-template, default: \"2006-01-02T15:04:05Z07:00\")",
                    "type": "string"
                },
                "verbose": {
                    "description": "Verbosity level (-v, --verbose, 0-3)",
                    "type": "integer"
                }
            }
        },
        "backupmgr.ResticPruneOption": {
            "type": "object",
            "properties": {
                "max_repack_size": {
                    "description": "e.g., \"500M\", \"5G\". Empty means omit.",
                    "type": "string"
                },
                "max_unused": {
                    "description": "e.g., \"500M\", \"5G\". Empty means omit.",
                ...
                "repack_cacheable_only": {
                    "description": "Only repack cacheable blobs",
                    "type": "boolean"
                },
                "repack_small": {
                    "description": "Repack small blobs",
                    "type": "boolean"
                },
                "repack_uncompressed": {
                    "description": "Repack uncompressed blobs",
                    "type": "boolean"
                }
            }
        },
        "backupmgr.ResticPurgeOption": {
            ...
            "properties": {
                "compact": {
                    "description": "Enable compact output during forget",
                    "type": "boolean"
                },
                "dry_run": {
                    "type": "boolean"
                ...
                "prune": {
                    "description": "When true, runs prune after forget to reclaim space (defaults to true via NewResticPurgeOption)",
                    "type": "boolean"
                },
                "prune_option": {
                    "$ref": "#/definitions/backupmgr.ResticPruneOption"
                },
                "snapshot_id": {
                    "type": "string"
                },
        ...
        "backupmgr.ResticRestoreOption": {
            ...
            "properties": {
                ...
                "global_opt": {
                    "description": "Global restic flags",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticGlobalOption"
                        }
                    ]
                },
                "host": {
                    "description": "Filter by host for \"latest\" snapshot",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "iexclude": {
                    "description": "Case-insensitive exclude patterns",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "iinclude": {
                    "description": "Case-insensitive include patterns",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "overwrite": {
                    "description": "Overwrite policy (non-standard, custom implementation)",
                    "type": "string"
                },
                "path": {
                    "description": "Filter by path for \"latest\" snapshot",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "tag": {
                    "description": "Filter by tag for \"latest\" snapshot",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "backupmgr.ResticTask": {
            "type": "object",
            "properties": {
                "backup_opt": {
                    "description": "Options for BackupTask",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticBackupOption"
                        }
                    ]
                },
                "changepass_opt": {
                    "description": "Options for ChangePassTask",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticChangePassOption"
                        }
                    ]
                },
                "check_opt": {
                    "description": "Options for CheckTask",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticCheckOption"
                        }
                    ]
                },
                "fetch_opt": {
                    "description": "Options for FetchTask",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticFetchOption"
                        }
                    ]
                },
                "init_opt": {
                    "description": "Options for InitTask",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticInitOption"
                        }
                ...
                "purge_opt": {
                    "description": "Options for PurgeTask",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticPurgeOption"
                        }
                    ]
                },
                "restore_opt": {
                    "description": "Options for RestoreTask",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticRestoreOption"
                        }
                    ]
                },
                "task_id": {
                ...
                "unlock_opt": {
                    "description": "Options for UnlockTask",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticUnlockOption"
                        }
                    ]
                }
            }
        ...
        "backupmgr.ResticUnlockOption": {
            ...
            "properties": {
                "remove_all": {
                    "description": "Remove all locks, including from other hosts",
                    "type": "boolean"
                }
            }
        },
        ...
        "cluster.Cluster": {
            ...
            "properties": {
                ...
                "inResticLogicalBackup": {
                    "type": "boolean"
                },
                "inResticPhysicalBackup": {
                    "type": "boolean"
                },
                "inRollingRestart": {
                    "type": "boolean"
        ...
        "cluster.ReconciliationReport": {
            ...
            "properties": {
                ...
                "missingMetadata": {
                    "description": "Snapshots without metadata files",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "orphanedMetadata": {
                    "description": "Metadata files referencing deleted snapshots",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "cluster.ServerMonitor": {
            ...
            "properties": {
                ...
                "restartNode": {
                    "description": "RestartNode stores node parameter for restart container cookie (owned by cookie mechanism, single writer assumption)",
                    "type": "string"
                },
                "restartRid": {
                    "description": "RestartRid stores rid parameter for restart container cookie (owned by cookie mechanism, single writer assumption)",
                    "type": "string"
                },
        ...
        "github_com_signal18_replication-manager_config.Config": {
            ...
            "properties": {
                ...
                "backupMyDumperStream": {
                    "type": "boolean"
                },
                "backupMyDumperStreamFile": {
                    "type": "string"
                },
                "backupMyDumperStreamFormat": {
                    "type": "string"
                },
                ...
                "backupReconcileAutoCleanup": {
                    "type": "boolean"
                },
                "backupReconcileInterval": {
                    "type": "integer"
                },
                "backupReseedRemoteDecompress": {
                    "type": "boolean"
                },
                "backupRestic": {
                    "type": "boolean"
                ...
                "backupResticDumpTimeout": {
                    "type": "integer"
                },
                "backupResticFileMode": {
                    "type": "integer"
                },
                "backupResticHost": {
                    "type": "string"
                ...
                "backupResticMetadataExtractorConcurrency": {
                    "type": "integer"
                },
                "backupResticMountAllowOther": {
                    "type": "boolean"
                },
                ...
                "backupResticMountNoDefaultPermissions": {
                    "type": "boolean"
                },
                "backupResticMountNoLock": {
                    "type": "boolean"
                },
                "backupResticMountOwnerRoot": {
                    "type": "boolean"
                },
                "backupResticMountPath": {
                    "type": "string"
                },
                "backupResticMountPathTemplate": {
                    "type": "string"
                },
                "backupResticMountQuiet": {
                    "type": "boolean"
                },
                "backupResticMountRecoveryEnabled": {
                    "description": "BackupResticMountRecoveryEnabled controls cleanup of stale restic mounts on startup.",
                    "type": "boolean"
                },
                "backupResticMountTag": {
                    "type": "string"
                },
                "backupResticMountTargetDir": {
                    "description": "Restic mount settings (used for manual mount operations).",
                    "type": "string"
                },
                "backupResticMountTimeTemplate": {
                    "type": "string"
                },
                "backupResticMountVerbose": {
                    "type": "integer"
                },
                "backupResticPurgeGroupBy": {
                    "type": "string"
                },
                "backupResticPurgeHost": {
                    "type": "string"
                },
                "backupResticPurgeKeepTag": {
                    "type": "string"
                },
                ...
                "backupResticPurgePath": {
                    "type": "string"
                },
                "backupResticPurgePrune": {
                    "type": "boolean"
                },
                "backupResticPurgePruneCompact": {
                    "type": "boolean"
                },
                "backupResticPurgePruneMaxRepackSize": {
                    "type": "string"
                },
                "backupResticPurgePruneMaxUnused": {
                    "type": "string"
                },
                "backupResticPurgePruneRepackCacheableOnly": {
                    "type": "boolean"
                },
                "backupResticPurgePruneRepackSmall": {
                    "type": "boolean"
                },
                "backupResticPurgePruneRepackUncompressed": {
                    "type": "boolean"
                },
                ...
                "backupResticReseedCleanup": {
                    "type": "boolean"
                },
                "backupResticReseedStrategy": {
                    "type": "string"
                },
                "backupResticReseedTempDir": {
                    "type": "string"
                },
                "backupResticReseedTimeout": {
                    "type": "integer"
                },
                "backupResticTags": {
                    "type": "string"
        ...
        "meethelper.MeetAlert": {
            ...
            "properties": {
                ...
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/meethelper.MeetAlertField"
                    }
                },
                "id": {
                    "type": "string"
        ...
        "meethelper.MeetChannelMessages": {
            "type": "object",
            "properties": {
                "channelId": {
                    "type": "string"
                ...
                "channelType": {
                    "description": "O:Open, P:Private, D:Direct",
                    "type": "string"
                },
                "messages": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/meethelper.MeetMessage"
                    }
                },
                "unReadMessages": {
                    "type": "integer"
        ...
        "meethelper.MeetMessage": {
            "type": "object",
            "properties": {
                "alertMetadata": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/meethelper.MeetAlert"
                    }
                },
                "channelID": {
                    "type": "string"
                ...
                "fileMetadata": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/meethelper.MeetFile"
                    }
                },
                "id": {
                    "type": "string"
                ...
                "meetingMetadata": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/meethelper.MeetingData"
                    }
                },
                "message": {
                    "type": "string"
        ...
        "server.ResticMountToggleRequest": {
            "type": "object",
            "properties": {
                "action": {
                    "description": "\"mount\" or \"unmount\"",
                    "type": "string"
                },
                "options": {
                    "description": "Mount options (only for \"mount\" action)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/backupmgr.ResticMountOption"
                        }
                    ]
                }
            }
        },
        "server.ResticReseedRequest": {
            "type": "object",
            "properties": {
                "cleanup": {
                    "type": "boolean"
