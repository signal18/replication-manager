...
var ClusterError = map[string]string{
	...
	"WARN0150":  "Orchestrator node(s) has reached minimum available memory threshold. Stats: %v",
	"WARN0151":  "Orchestrator node(s) has reached minimum available swap threshold. Stats: %v",
