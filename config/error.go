...
var ClusterError = map[string]string{
	...
	"WARN0139":  "Backup partition used size exceed warning treshold. Mounts: %v Treshold: %d",
	"WARN0140":  "Backup partition used size exceed critical treshold. %s Mounts: %v Treshold: %d",
	...
	"WARN0163":  "Cluster %s has schema differences between master and slaves: %v",
