...
var ClusterError = map[string]string{
	...
	"WARN0139":  "Not enough free space estimated for %s logical backup on %s. Mount: %s Free: %s Required: %s",
	"WARN0140":  "Not enough free space estimated for %s physical backup on %s. Mount: %s Free: %s Required: %s",
	"WARN0141":  "Not enough free space estimated for binary log backup on %s. Mount: %s Free: %s Required: %s",
