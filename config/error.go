...
func GetDefaultAlertStateCodes() []string {
	return []string{
		"ERR00001", //"Monitor freeze while running critical section"
		"ERR00002", //  "Waiting for a user manual failover",
		"ERR00010", //  "Could not find a slave in topology",
		...
		"WARN0081", //  "Cluster arbitrator error in reporting %s",
		"WARN0082", //  "Cluster arbitrator error in arbitration %s",
		"WARN0100", //  "No space left on device n %s",
	}
}

// CONN group
func GetNetworkConnStateCodes() []string {
	return []string{
		"ERR00018", // "Could not connect to MaxScale: %s",
		"ERR00044", // "Can't connect to OpenSVC collector %s",
		"ERR00050", // "Can't connect to proxy %s",
...
func GetPrivilegeStateCodes() []string {
	return []string{
		"ERR00004", // "Database %s access denied: %s"
		"ERR00005", // "Could not get privileges for user %s@%s: %s",
		"ERR00006", // "User must have REPLICATION CLIENT privilege on %s",
...
func GetSlaveStateCodes() []string {
	return append(GetSlaveErrStateCodes(), GetSlaveWarnStateCodes()...)
}

func GetSlaveErrStateCodes() []string {
	return []string{
		"ERR00007", // "User must have REPLICATION SLAVE privilege on %s",
		"ERR00010", // "Could not find a slave in topology",
		"ERR00013", // "Binary log disabled on slave: %s",
...
func GetSlaveWarnStateCodes() []string {
	return []string{
		"WARN0048", // "No semisync settings on slave %s",
		"WARN0049", // "No binlog format ROW on slave %s and flashback activated",
		"WARN0050", // "No Heartbeat <= 1s on slave %s",
...
// Group can be used in state list in config
func IsCodeInGroup(group string, code string) bool {
	switch group {
	case "SLAVE":
		return slices.Contains(GetSlaveStateCodes(), code)
	case "SLAVE-ERR":
		return slices.Contains(GetSlaveErrStateCodes(), code)
	case "SLAVE-WARN":
		return slices.Contains(GetSlaveWarnStateCodes(), code)
	case "PRIVILEGE":
		return slices.Contains(GetPrivilegeStateCodes(), code)
	case "CONN":
		return slices.Contains(GetNetworkConnStateCodes(), code)
	case "DEFAULT":
		return slices.Contains(GetDefaultAlertStateCodes(), code)
	}
	return false
}
