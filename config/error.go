...
var ClusterError = map[string]string{
	...
	"ERR00033": "Skip slave in election - have no master log file, slave might have failed",
	...
	"ERR00038": "Skip slave in election - repl not electable for failover",
	...
	"ERR00043": "Skip slave in election - Semisync report unsynced",
	...
	"ERR00060": "To many non closed task in scheduler, donor may not work on server",
	...
	"ERR00065": "No crash found on current master when rejoining slave to %s",
	"ERR00066": "No crash found on current master when rejoining standalone to %s",
	...
	"ERR00079": "Disk %s usage high",
	"ERR00080": "Connection use old TLS keys",
	"ERR00081": "Connection use no TLS keys",
	...
	"WARN0022": "Rejoining standalone server to master %s",
	...
	"WARN0050": "No Heartbeat <= 1s on slave",
	"WARN0051": "No GTID replication on slave",
	"WARN0052": "No InnoDB durability on slave",
	"WARN0053": "No replication checksum on slave",
	"WARN0054": "No log of replication queries in slow query on slave",
	"WARN0055": "ROW or MIXED binlog format and replicate_annotate_row_events is off on slave",
	"WARN0056": "No compression of binlog on slave",
	"WARN0057": "No log-slave-updates on slave",
	"WARN0058": "No GTID strict mode on slave",
	"WARN0059": "No replication crash-safe settings on slave",
	"WARN0060": "No semisync settings on master",
	"WARN0061": "No binlog format ROW on master and flashback activated",
	"WARN0062": "No Heartbeat <= 1s on master",
	"WARN0064": "No InnoDB durability on master",
	"WARN0065": "No replication checksum on master",
	"WARN0066": "No log of replication queries in slow query on master",
	"WARN0067": "RBR is on and Binlog Annotation is off on master",
	"WARN0068": "No compression of binlog on slave",
	"WARN0069": "No log-slave-updates on master",
	"WARN0070": "No GTID strict mode on master",
	"WARN0071": "No replication crash-safe settings on master",
	"WARN0072": "Running optimize table %s on server",
	...
	"WARN0085": "server in capture mode",
	"WARN0086": "Checksum table waiting replication sync on slave",
	...
	"WARN0103": "Enforce replication mode idempotent but  strict on server",
	...
	"WARN0110": "Pending %s backup using %s due to another job. Waiting...",
