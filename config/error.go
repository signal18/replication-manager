...
var ClusterError = map[string]string{
	...
	"WARN0217":  "Switchover waiting for %d long write(s) on %s to complete (past switchover-wait-write-query=%ds), cancelled if still running after switchover-wait-trx=%ds; never killed",
