...
var ClusterError = map[string]string{
	...
	"WARN0139":  "Backup partition used size exceed warning treshold. Mount: %s Used: %.2f Treshold: %d",
	"WARN0140":  "Backup partition used size exceed critical treshold. Mount: %s Used: %.2f Treshold: %d",
	...
	"WARN0159":  "Replication Manager used a deprecated configuration key in default config. Keys: %s",
	"WARN0160":  "Replication Manager used a deprecated configuration key in cluster %s. Keys: %s",
