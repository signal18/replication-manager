...
var ClusterError = map[string]string{
	...
	"WARN0139":  "Backup partition used size exceed warning treshold. Mount: %s Used: %.2f Treshold: %.2f",
	"WARN0140":  "Backup partition used size exceed critical treshold. Mount: %s Used: %.2f Treshold: %.2f",
