...
var ClusterError = map[string]string{
	...
	"CINF0007":  "Server %s: consumption of axes %s reached its config limit, scale UP needed (in-plan)",
	"CINF0008":  "Server %s: consumption of axes %s well under its config, scale DOWN possible (in-plan)",
	"CINF0009":  "Server %s: consumption of axes %s well under the plan, plan cap-down possible",
	"WARN0213":  "Server %s: consumption of axes %s reached the plan cap, plan cap-UP needed -- raise the plan",
