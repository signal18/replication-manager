...
var ClusterError = map[string]string{
	...
	"WARN0213":   "Resource sensor on %s is not usable: %s -- monitoring-system-resources is on but the DBU reading cannot be trusted right now",
	...
	"CINF0007":  "Server %s: resources scaling UP in-plan (axes: %s) -- config saturated for the set speed",
	"CINF0008":  "Server %s: resources scaling DOWN in-plan (axes: %s) -- config under-used for the set speed",
	"CINF0009":  "Server %s: plan cap-down possible (axes: %s) -- under the plan for the set speed",
	"WARN0213":  "Server %s: plan cap-UP due (axes: %s) -- at the plan cap for the set speed, raise the plan",
