...
type Config struct {
	...
	ProvDBUndercommitPct                     int                          `mapstructure:"prov-db-undercommit-pct" toml:"prov-db-undercommit-pct" json:"provDbUndercommitPct"`                             // scale-down floor: auto-shrink never under floor(plan x (1 - pct/100)) DBU/node, min 1 -- the pendant of prov-db-overcommit-pct
	...
	// Client-settable SCALE SPEED: how long a saturation must persist before repman scales the
	...
	ScaleUpConfigInPlanSpeed                  string            `mapstructure:"prov-db-scale-up-config-in-plan-speed" toml:"prov-db-scale-up-config-in-plan-speed" json:"scaleUpConfigInPlanSpeed"`       // sustain duration before scaling UP a server's config resources within the plan. Default 1m
	ScaleDownConfigInPlanSpeed                string            `mapstructure:"prov-db-scale-down-config-in-plan-speed" toml:"prov-db-scale-down-config-in-plan-speed" json:"scaleDownConfigInPlanSpeed"` // sustain duration before scaling DOWN a server's config resources within the plan. Default 5m
	ScaleUpPlanSpeed                          string            `mapstructure:"prov-db-scale-up-plan-speed" toml:"prov-db-scale-up-plan-speed" json:"scaleUpPlanSpeed"`                                   // sustain duration before raising the PLAN (cap up) -- commercial, slower than in-plan. Default 30m
	...
	ProvProxyApu                              int               `mapstructure:"prov-proxy-apu" toml:"prov-proxy-apu" json:"provProxyApu"`
	...
	Cloud18MarketplaceMonthlyDbopsCost      float64                `scope:"server" mapstructure:"cloud18-marketplace-monthly-dbops-cost" toml:"cloud18-marketplace-monthly-dbops-cost" json:"cloud18MarketplaceMonthlyDbopsCost"`
	...
	Cloud18MarketplaceSlaResponseTime       float64                `scope:"server" mapstructure:"cloud18-marketplace-sla-response-time" toml:"cloud18-marketplace-sla-response-time" json:"cloud18MarketplaceSlaResponseTime"`
	Cloud18MarketplaceSlaRepairTime         float64                `scope:"server" mapstructure:"cloud18-marketplace-sla-repair-time" toml:"cloud18-marketplace-sla-repair-time" json:"cloud18MarketplaceSlaRepairTime"`
	Cloud18MarketplaceSlaProvisionTime      float64                `scope:"server" mapstructure:"cloud18-marketplace-sla-provision-time" toml:"cloud18-marketplace-sla-provision-time" json:"cloud18MarketplaceSlaProvisionTime"`
	Cloud18MarketplacePromotionPct          float64                `scope:"server" mapstructure:"cloud18-marketplace-promotion-pct" toml:"cloud18-marketplace-promotion-pct" json:"cloud18MarketplacePromotionPct"`
	Cloud18MarketplaceInfraCertifications   string                 `scope:"server" mapstructure:"cloud18-marketplace-infra-certifications" toml:"cloud18-marketplace-infra-certifications" json:"cloud18MarketplaceInfraCertifications"`
