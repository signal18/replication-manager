...
type Config struct {
	...
	BackupResticPurgeOldestOnDiskTreshold     int                    `mapstructure:"backup-restic-purge-oldest-on-disk-treshold" toml:"backup-restic-purge-oldest-on-disk-treshold" json:"backupResticPurgeOldestOnDiskTreshold"`
