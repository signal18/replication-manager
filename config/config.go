...
type Config struct {
	...
	BackupEncryptionStreamTransport        bool                   `mapstructure:"backup-encryption-stream-transport" toml:"backup-encryption-stream-transport" json:"backupEncryptionStreamTransport"`
