...
ARG PLUGIN_PUSH="OFF"
ARG PLUGIN_CHANNEL="release"
RUN make pro cli PLUGIN_SIGNER_USER="$PLUGIN_SIGNER_USER" PLUGIN_SIGNER_TOKEN="$PLUGIN_SIGNER_TOKEN" PLUGIN_PUSH="$PLUGIN_PUSH" PLUGIN_CHANNEL="$PLUGIN_CHANNEL"
