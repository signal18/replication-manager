...
var configMergeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("Start config merge command !!\n")
		fmt.Println("Cluster: ", cfgGroup)
		fmt.Println("Config : ", conf.ConfigFile)
...
func init() {
	...
	configMergeCmd.PersistentFlags().StringVar(&cfgGroup, "cluster", "", "Configuration group (default is none)")
