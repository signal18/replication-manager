...
func (repman *ReplicationManager) AddFlags(flags *pflag.FlagSet, conf *config.Config, isClient bool) {
	...
	flags.Float64Var(&conf.Cloud18MarketplaceAPUPrice, "cloud18-marketplace-apu-price", 0, "Price per APU (Application Unit: 1 core, 1 GB RAM, 10 GB disk, no IOPS) in Eur, used when cloud18-marketplace-pricing-mode is global-unit-pricing")
