...
func (repman *ReplicationManager) AddFlags(flags *pflag.FlagSet, conf *config.Config, isClient bool) {
	...
	flags.StringVar(&conf.ProvAppDisk, "prov-app-disk-size", "10", "Disk in g for micro service VM. When cloud18 credit system is used, this is the base for 1 credit")
	...
	flags.StringVar(&conf.ProvAppMem, "prov-app-memory", "4096", "Memory usage in M bytes. When cloud18 credit system is used, this is the base for 1 credit")
	...
	flags.BoolVar(&conf.ProvAppVolumeAllowAdvancedSize, "prov-app-volume-allow-advanced-size", false, "Allow advanced arbitrary canonical app volume sizes instead of credit-step sizing")
