...
func (repman *ReplicationManager) AddFlags(flags *pflag.FlagSet, conf *config.Config) {
	...
	if WithProvisioning == "ON" {
		...
		flags.StringVar(&conf.ProvAppSlot1Agents, "prov-app-slot1-agents", "", "Comma seperated list of agents for micro services provisionning")
		flags.StringVar(&conf.ProvAppSlot1DiskSize, "prov-app-slot1-disk-size", "20", "Disk in g for micro service VM")
		flags.StringVar(&conf.ProvAppSlot1CpuCores, "prov-app-slot1-cpu-cores", "1", "Number of cpu cores for the micro service VM")
		flags.StringVar(&conf.ProvAppSlot1Memory, "prov-app-slot1-memory", "256", "Memory in M for micro service VM")
		flags.StringVar(&conf.ProvAppSlot1VolumeData, "prov-app-slot1-volume-data", "default", "Volume name of the data files")
		flags.StringVar(&conf.ProvAppSlot1DockerRunArgs, "prov-app-slot1-docker-run-args", "--ulimit nofile=262144:262144 --sysctl net.ipv4.tcp_tw_reuse=1 --sysctl net.core.somaxconn=1024  --sysctl net.ipv4.tcp_fin_timeout=10", "Additional docker run arguments for app")
		flags.StringVar(&conf.ProvAppSlot1DockerImg, "prov-app-slot1-docker-img", "signal18/php8:latest", "Docker image for app")
		flags.StringVar(&conf.AppSlot1Hosts, "app-slot1-hosts", "app1:80,app2:80", "")
		flags.StringVar(&conf.AppSlot1RunCommand, "app-slot1-run-command", "", "Container run command")
		flags.StringVar(&conf.AppSlot1ConfigGitCloneUrl, "app-slot1-config-git-clone-url", "", "Git clone url to fetch config")
		flags.StringVar(&conf.AppSlot1ConfigGitUser, "app-slot1-config-git-user", "", "Git user to to fetch config")
		flags.StringVar(&conf.AppSlot1ConfigGitPassword, "app-slot1-config-git-password", "", "Git password to to fetch config")
		flags.StringVar(&conf.AppSlot1ConfigGitBranch, "app-slot1-config-git-branch", "master", "Git branch to to fetch config")
		flags.StringVar(&conf.AppSlot1ConfigSecretVariables, "app-slot1-config-secret-variables", "", "List of key:value,key:value")
		flags.StringVar(&conf.AppSlot1ConfigEnvVariables, "app-slot1-config-env-variables", "", "List of key:value,key:value")
		flags.StringVar(&conf.AppSlot1ConfigVolumes, "app-slot1-config-volumes", "", "List of key:value,key:value")
		flags.StringVar(&conf.AppSlot1DataGitCloneUrl, "app-slot1-data-git-clone-url", "", "Git clone url to fetch config")
		flags.StringVar(&conf.AppSlot1DataGitUser, "app-slot1-data-git-user", "", "Git user to to fetch data")
		flags.StringVar(&conf.AppSlot1DataGitPassword, "app-slot1-data-git-password", "", "Git password to to fetch data")
		flags.StringVar(&conf.AppSlot1DataGitBranch, "app-slot1-data-git-branch", "master", "Git branch to to fetch data")
		flags.StringVar(&conf.AppSlot1DataVolumes, "app-slot1-data-volumes", "", "List of key:value,key:value")
		flags.StringVar(&conf.AppSlot1LogVolumes, "app-slot1-log-volumes", "", "List of key:value,key:value")
