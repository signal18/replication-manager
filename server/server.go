...
func (repman *ReplicationManager) AddFlags(flags *pflag.FlagSet, conf *config.Config) {
	...
	flags.BoolVar(&conf.MonitorPFSMutex , "monitoring-performance-schema-mutex"  , true , "Graph mutex metrics")
	flags.BoolVar(&conf.MonitorPFSLatch  ,"monitoring-performance-schema-latch" , true , "Graph Latch metrics")
