...
type ReplicationManager struct {
	...
	ClusterHeartbeatSnapshot   map[string]int64                  `json:"-"`
	ClusterHeartbeatLastChange map[string]int64                  `json:"-"`
...
func (repman *ReplicationManager) AddFlags(flags *pflag.FlagSet, conf *config.Config, isClient bool) {
	...
	flags.IntVar(&conf.MonitorGlobalHeartbeatStallThreshold, "monitoring-global-heartbeat-stall-threshold", 5, "Number of stalled heartbeat cycles before opening global warning")
